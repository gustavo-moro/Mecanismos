...
# Função perfil 3-4-5 para subida e descida
def perfil_345(theta, theta0, beta_degrees, h0, h_max):
    """
    Calcula o perfil de posição, velocidade e aceleração usando o perfil 3-4-5.
    """
    ...
    E = h0 + delta_h * (10 * t**3 - 15 * t**4 + 6 * t**5)
    V = (delta_h / beta) * (30 * t**2 - 60 * t**3 + 30 * t**4)
    A = (delta_h / beta**2) * (60 * t - 180 * t**2 + 120 * t**3)
    return E, V, A
...
for i in range(3):  # Três ciclos completos
    ...
    E[mask_subida], V[mask_subida], A[mask_subida] = perfil_345(
    ...
    E[mask_descida], V[mask_descida], A[mask_descida] = perfil_345(
